...
Note that if $\alpha < \omega_1^{CK}$ and $\alpha$ is a limit ordinal, then $\emptyset^{(\alpha)}:=sup(\cup_{\beta < \alpha} \emptyset^{(\beta)})=\{\langle x, \beta \rangle \in \mathbb{N} : x \in \emptyset^{(\beta)} \land \beta < \alpha\}$.
